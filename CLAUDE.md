...
- `docs/sam-gov-checklist.md` — what to obtain (UEI, CAGE, NAICS, certs) to replace the capability-statement placeholders on the Experience page (`/capabilities/`) once SAM.gov registration is done.
